...
set JAVA_OPTS="-Dhsqldb_database=%CATALINA_HOME%/blogdata/rollerdb -Dhsqldb_port=8802 -DrollerPageDir=%CATALINA_HOME%/wikidata -DrollerStorageDir=%CATALINA_HOME%/wikiattachments"
