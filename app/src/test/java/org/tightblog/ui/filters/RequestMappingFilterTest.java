...
public class RequestMappingFilterTest {
    ...
    public void testCalculateForwardUrl() throws Exception {
        ...
        assertEquals(filter.generateForwardUrl(PageProcessor.PATH, "handle", null, "data"), pageTest1);
        String pageTest2 = filter.calculateForwardUrl(mockRequest, "handle", "page", "data");
        assertEquals(filter.generateForwardUrl(PageProcessor.PATH, "handle", "page", "data"), pageTest2);
        String pageTest3 = filter.calculateForwardUrl(mockRequest, "handle", "entry", "data");
        assertEquals(filter.generateForwardUrl(PageProcessor.PATH, "handle", "entry", "data"), pageTest3);
        String pageTest4 = filter.calculateForwardUrl(mockRequest, "handle", "date", "data");
        assertEquals(filter.generateForwardUrl(PageProcessor.PATH, "handle", "date", "data"), pageTest4);
        String pageTest5 = filter.calculateForwardUrl(mockRequest, "handle", "category", "data");
        assertEquals(filter.generateForwardUrl(PageProcessor.PATH, "handle", "category", "data"), pageTest5);
        ...
        String mediaTest = filter.calculateForwardUrl(mockRequest, "handle", "mediaresource", "data");
        ...
        assertEquals(filter.generateForwardUrl(SearchProcessor.PATH, "handle", "search", null), searchTest);
        ...
        assertEquals(filter.generateForwardUrl(CommentProcessor.PATH, "handle", "entry", "data"), commentTest2);
    }
