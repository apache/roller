 ...
 *
 * Overrides s:checkboxlist elements with theme attribute of "roller"
 * Struts2 customization info: https://struts.apache.org/docs/struts-2-themes.html
 *
 * Modifications: Add <br/> to the end of each checkbox generated by checkboxlist
 */
-->
<#assign itemCount = 0/>
<#if parameters.list??>
