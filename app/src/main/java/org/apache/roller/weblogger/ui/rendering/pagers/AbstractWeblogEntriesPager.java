...
public abstract class AbstractWeblogEntriesPager implements WeblogEntriesPager {
    ...
    protected Date parseDate(String dateString) {
        ...
        if (   dateString!=null
            ...
            FastDateFormat char8DateFormat = FastDateFormat.getInstance(WebloggerCommon.FORMAT_8CHARS,
        ...
        if (   dateString!=null
                && dateString.length()==6
                && StringUtils.isNumeric(dateString) ) {
            FastDateFormat char6DateFormat = FastDateFormat.getInstance(WebloggerCommon.FORMAT_6CHARS,
                    weblog.getTimeZoneInstance(), weblog.getLocaleInstance());
            ParsePosition pos = new ParsePosition(0);
