...
public interface CommentValidator {
     ...
     * @return ValidationResult generated by the validator for the comment
     */
    ValidationResult validate(WeblogEntryComment comment, Map<String, List<String>> messages);
}
