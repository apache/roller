...
import org.tightblog.pojos.PingResult;
...
public class PingTargetManagerImpl implements PingTargetManager {

    private static Logger log = LoggerFactory.getLogger(PingTargetManagerImpl.class);
    ...
    protected PingTargetManagerImpl(JPAPersistenceStrategy strategy, URLStrategy urlStrategy) {
