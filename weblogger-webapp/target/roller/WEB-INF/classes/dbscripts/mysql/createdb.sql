...
alter table rolleruser add constraint ru_username_uq unique ( username(40) );
...
create table webpage (
    ...
    navbar          tinyint(1) default 0 not null,
...
create table website (
    ...
    ignorewords       text,
    enablebloggerapi  tinyint(1) default 0 not null,
    editorpage        varchar(255),
    bloggercatid      varchar(48),
    defaultcatid      varchar(48),
    allowcomments     tinyint(1) default 1 not null,
    emailcomments     tinyint(1) default 0 not null,
    ...
    datecreated          datetime not null,
    blacklist            text,
    defaultallowcomments tinyint(1) default 1 not null,
    defaultcommentdays   integer default 7 not null,
    commentmod           tinyint(1) default 0 not null,
    displaycnt           integer default 15 not null,
    lastmodified         datetime,
    pagemodels           varchar(255) default null,
    enablemultilang   tinyint(1) default 0 not null,
    showalllangs      tinyint(1) default 1 not null,
    customstylesheet  varchar(128),
    about             varchar(255),
    icon              varchar(255)
);
create index ws_isenabled_idx on website(isenabled);
alter table website add constraint ws_handle_uq unique (handle(40));
...
create table weblogentry (
    ...
    websiteid       varchar(48)  not null,
    categoryid      varchar(48)  not null,
    publishentry    tinyint(1) default 1 not null,
    link            varchar(255),
    plugins         varchar(255),
    allowcomments   tinyint(1) default 0 not null, 
    commentdays     integer default 7 not null,
    rightToLeft     tinyint(1) default 0 not null,
    pinnedtomain    tinyint(1) default 0 not null,
    locale          varchar(20),
...
create table pingtarget (
    ...
    autoenabled  tinyint(1) default 0 not null
);
...
create table referer (
    ...
    duplicate tinyint(1) default 0 not null
);
...
create table rollerconfig (
    ...
    encryptpasswords tinyint(1) default 1 not null,
    algorithm       varchar(10),
    newuserallowed  tinyint(1) default 0 not null,
    editorpages     varchar(255),
    userthemes      varchar(255) not null,
    indexdir        varchar(255),
    memdebug        tinyint(1) default 0 not null,
    autoformatcomments tinyint(1) default 0 not null,
    escapecommenthtml tinyint(1) default 1 not null,
    emailcomments   tinyint(1) default 0 not null,
    enableaggregator tinyint(1) default 0 not null,
    enablelinkback  tinyint(1) default 0 not null,
    rsscachetime    integer default 3000 not null,
    rssusecache     tinyint(1) default 1 not null,
    uploadallow     varchar(255),
    uploadforbid    varchar(255),
    uploadenabled   tinyint(1) default 1 not null,
...
alter table entryattribute add constraint ea_name_uq unique ( entryid, name(40) );
