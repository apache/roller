...
create table rolleruser (
    ...
    datecreated     timestamp(2) not null,
    locale          varchar(20),  
    timezone        varchar(50),    
...
create table webpage (
    ...
    updatetime      timestamp(2) not null,
...
create table pingqueueentry (
    id             varchar(48) not null primary key,
    entrytime      timestamp(2) not null, 
    pingtargetid   varchar(48) not null,  
    websiteid      varchar(48) not null,  
...
create table roller_tasklock (
    ...
    timeacquired    timestamp(2) null,
    timeleased	    integer,
    lastrun         timestamp(2) null,
    client          varchar(255)
);
...
create table rag_entry (
    ...
    content          clob,
    categories       clob,
    published        timestamp(2) not null,
    updated          timestamp(2)    
);
...
create table roller_mediafile (
    ...
    date_uploaded   timestamp(2) not null,
    last_updated    timestamp(2),
    anchor          varchar(255),
    creator         varchar(255),
