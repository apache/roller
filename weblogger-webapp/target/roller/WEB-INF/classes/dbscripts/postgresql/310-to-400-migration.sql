...
update roller_comment set status = 'APPROVED', posttime=posttime where approved=true;
update roller_comment set status = 'PENDING', posttime=posttime where pending=true;
update roller_comment set status = 'SPAM', posttime=posttime where spam=true;

update roller_comment set status = 'DISAPPROVED', posttime=posttime 
   where approved=false and spam=false and pending=false;
...
update website set enablemultilang=true, datecreated=datecreated where showalllangs=false;
