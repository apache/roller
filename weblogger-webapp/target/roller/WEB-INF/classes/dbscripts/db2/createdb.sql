...
create table website (
    ...
    ignorewords       clob(102400),
    enablebloggerapi  smallint default 0 not null,
    editorpage        varchar(255),
    bloggercatid      varchar(48),
    defaultcatid      varchar(48),
    allowcomments     smallint default 1 not null,
    emailcomments     smallint default 0 not null,
    ...
    defaultallowcomments smallint default 1 not null,
    defaultcommentdays   integer default 7 not null,
    commentmod           smallint default 0 not null,
    displaycnt           integer default 15 not null,
    lastmodified         timestamp,
    pagemodels           varchar(255) default null,
    enablemultilang   smallint default 0 not null,
    showalllangs      smallint default 1 not null,
...
create table weblogentry (
    ...
    websiteid       varchar(48)  not null,
    categoryid      varchar(48)  not null,
    publishentry    smallint default 1 not null,
    link            varchar(255),
    plugins         varchar(255),
    allowcomments   smallint default 0 not null, 
    commentdays     integer default 7 not null,
    rightToLeft     smallint default 0 not null,
    pinnedtomain    smallint default 0 not null,
    locale          varchar(20),
    status          varchar(20) not null,
    summary         clob(102400) default null, 
...
create table pingtarget (
    ...
    autoenabled  smallint default 0 not null
);
...
create table rollerconfig (
    ...
    encryptpasswords smallint default 1 not null,
    algorithm       varchar(10),
    newuserallowed  smallint default 0 not null,
    editorpages     varchar(255),
    userthemes      varchar(255) not null,
    indexdir        varchar(255),
    memdebug        smallint default 0 not null,
    autoformatcomments smallint default 0 not null,
    escapecommenthtml smallint default 1 not null,
    emailcomments   smallint default 0 not null,
    enableaggregator smallint default 0 not null,
    enablelinkback  smallint default 0 not null,
    rsscachetime    integer default 3000 not null,
    rssusecache     smallint default 1 not null,
    uploadallow     varchar(255),
    uploadforbid    varchar(255),
    uploadenabled   smallint default 1 not null,
...
create table rag_entry (
    ...
    title            varchar(255),
    guid             varchar(255),
    permalink        clob(102400) not null,
    author           varchar(255),
    content          clob(102400),
    categories       clob(102400),
...
alter table webpage add constraint wp_websiteid_fk
    foreign key ( websiteid ) references website( id ) on delete no action on update no action enforced enable query optimization ;

alter table weblogentry add constraint we_websiteid_fk
    foreign key ( websiteid ) references website( id ) on delete no action on update no action enforced enable query optimization ;

alter table weblogentry add constraint wc_categoryid_fk
    foreign key ( categoryid ) references weblogcategory( id ) on delete no action on update no action enforced enable query optimization ;

alter table weblogcategory add constraint wc_websiteid_fk
    foreign key ( websiteid ) references website( id ) on delete no action on update no action enforced enable query optimization ;

alter table roller_comment add constraint co_entryid_fk
    foreign key ( entryid ) references weblogentry( id ) on delete no action on update no action enforced enable query optimization ;
...
alter table bookmark add constraint bm_folderid_fk
    foreign key ( folderid ) references folder( id ) on delete no action on update no action enforced enable query optimization ;

-- media file foreign key constraints

alter table roller_mediafile add constraint roller_mediafiledir_id_fk
    foreign key (directoryid) references roller_mediafiledir(id) on delete no action on update no action enforced enable query optimization ;

alter table roller_mediafiletag add constraint roller_mediafile_id_tag_fk
    foreign key (mediafile_id) references roller_mediafile(id) on delete no action on update no action enforced enable query optimization ;
...
alter table roller_mediafiledir add constraint mf_parentid_fk
    foreign key ( parentid ) references roller_mediafiledir( id )  on delete no action on update no action enforced enable query optimization ;
...
alter table autoping add constraint ap_pingtargetid_fk
    foreign key (pingtargetid) references pingtarget(id) on delete no action on update no action enforced enable query optimization ;

alter table pingcategory add constraint pc_autopingid_fk
    foreign key (autopingid) references autoping(id) on delete no action on update no action enforced enable query optimization ;
