...
As of 11 June 2016, TightBlog uses 17 database tables compared to Roller V5.1.2's 33, 207 Java source files from the 493 in Roller, and 57 JSPs to Roller's 92.  However about 20 more JavaScript files have been/will be added, about one for each main view.  See the OpenHub statistics (https://www.openhub.net/p/tightblog/analyses/latest/languages_summary) for trending code size and language breakdown.
