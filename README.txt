...
Welcome to TightBlog! Starting off in May 2015 as a fork of the Apache Roller project (Before then, I was a Roller committer for 2 1/2 years before departing due to accumulating differences of opinion), TightBlog strives to be the mathematically cleanest and simplest implementation of a Java based blog and planet server, suitable either for direct use or incorporation, as an Apache-licensed open source project, into larger projects.
...
As of 14 April 2016, TightBlog uses 18 database tables compared to Roller V5.1.2's 33, and has slimmed down to 235 Java source files from the 493 in Roller.
