...
As of 31 May 2016, TightBlog uses 18 database tables compared to Roller V5.1.2's 33, 211 Java source files from the 493 in Roller, and 61 JSPs to Roller's 92.  However more JavaScript files have been added to accommodate TightBlog's increased emphasis on browser-side processing.  See the OpenHub statistics (https://www.openhub.net/p/tightblog/analyses/latest/languages_summary) for trending code size and language breakdown.
