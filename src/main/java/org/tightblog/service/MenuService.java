...
public final class MenuService {
    ...
    @Autowired
    public MenuService(WebloggerPropertiesDao webloggerPropertiesDao, Environment env,
    ...
    void init() throws IOException {
        ...
        try (InputStream menuStream = MenuService.class.getResourceAsStream("/menus.json")) {
    ...
    private boolean getBooleanProperty(String propertyName) {
        if ("themes.customtheme.allowed".equals(propertyName)) {
            return webloggerPropertiesDao.findOrNull().isUsersCustomizeThemes();
        }
