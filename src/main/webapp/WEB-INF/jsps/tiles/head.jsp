...
<link rel="stylesheet" media="all" href="<c:url value='/styles/layout.css'/>" />
<link rel="stylesheet" media="all" href="<c:url value='/styles/tightblog.css'/>" />
<link rel="stylesheet" media="all" href="<c:url value='/styles/menu.css'/>" />
