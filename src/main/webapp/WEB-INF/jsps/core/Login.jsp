...
<form method="post" id="loginForm"
    ...
    <table width="80%">
        ...
        <tr>
            ...
            <td width="80%">
                <input type="text" name="username" id="j_username" value="gmazza" size="25" onBlur="this.value=this.value.trim()"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="80%">
                <input type="password" name="password" id="j_password" size="20" value="1@Password" onBlur="this.value=this.value.trim()"/>
            </td>
        </tr>
