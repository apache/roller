...
public class HibernateWeblogManagerImpl extends WeblogManagerImpl
{
     ...
     * @param roller
     */
    public HibernateWeblogManagerImpl(PersistenceStrategy strategy, Roller roller)
    {
                    ...
                    Boolean pinned) throws RollerException
    {
        ...
        try
        {
            ...
            {
                criteria.add(
                    Expression.gt("pubTime", DateUtil.getStartOfDay(startDate)));
            }
            
            if (endDate != null)
            {
                criteria.add(
                    Expression.lt("pubTime", DateUtil.getEndOfDay(endDate)));
            }
        ...
        throws RollerException
    {
        try
        {
            ...
            if (cat.getWebsite().getBloggerCategory().equals(this))
            {
                return true;
            }
            
            if (cat.getWebsite().getDefaultCategory().equals(this))
            {
                return true;
            }
