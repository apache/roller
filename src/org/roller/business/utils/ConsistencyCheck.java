...
/**
 * Roller database consistency checker.
...
public class ConsistencyCheck 
{
        ...
        throws SQLException
    {
        ...
        // weblog entris with bad category?
        findOrphans(con, "weblogentry", "categoryid", "weblogcategory", delete, verbose);
    ...
    public static void fixWebsites(Connection con) throws SQLException
    {
