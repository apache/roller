    ...
    public class MainPageData 
    {
        ...
        public List getPopularWebsites() throws RollerException
        {
            ...
            if (list == null)
            {
                ...
                list = roller.getRefererManager().getDaysPopularWebsites(40);
        ...
        public List getWeblogEntriesPinnedToMain() throws RollerException
        {
            ...
            if (list == null)
            {
                ...
                list = roller.getWeblogManager()
                    .getWeblogEntriesPinnedToMain(new Integer(5));  
