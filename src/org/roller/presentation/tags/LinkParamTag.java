/*
 * $Header: /cvsroot/roller/roller/src/org/roller/presentation/tags/LinkParamTag.java,v 1.1 2003/08/31 00:38:12 snoopdave Exp $
 * $Revision: 1.1 $
 * $Date: 2003/08/31 00:38:12 $
 *
 * ====================================================================
 */
...
public class LinkParamTag extends BodyTagSupport {
    // ----------------------------------------------------- Logging
    Category cat = Category.getInstance(LinkParamTag.class);
