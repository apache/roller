...
update comment set spam=@BOOLEAN_FALSE@, posttime=posttime;
...
-- more indexes for better performance
create index userrole_username_index on userrole( username );

create index weblogentry_pubtime_index on weblogentry( pubtime );
