...
<html:form action="/bookmarks" method="post">
<input type="hidden" name="method" /> 
<html:hidden property="folderId" /> 

<p>
<%-- Add Bookmark link --%>
<img src="images/BookmarkNew16.png" border="0"alt="icon" />
<roller:link page="/bookmarkEdit.do">
...
<%-- Add Folder link --%>
<img src="images/FolderNew16.png" border="0"alt="icon" />
<roller:link page="/folderEdit.do">
...
<table class="rollertable">
    ...
    <c:forEach var="folder" items="${folders}" >
        <roller:row oddStyleClass="rollertable_odd" evenStyleClass="rollertable_even">
            ...
            <td class="rollertable" align="center"><img src="images/Folder16.png"alt="icon" /></td>
    ...
    <c:forEach var="bookmark" items="${bookmarks}" >
        <roller:row oddStyleClass="rollertable_odd" evenStyleClass="rollertable_even">
            ...
            <td class="rollertable" align="center"><img src="images/Bookmark16.png"alt="icon" /></td>
            ...
            <td class="rollertable" align="center">
                <c:if test="${!empty bookmark.url}" >
                   <a href="<c:out value='${bookmark.url}'/>">
                       <img src="images/WebVisit16.png" border="0" alt="icon" 
