...
<html:form action="/weblog" method="post" focus="title">
    ...
    <%-- comment settings --%>
    <div class="row">
        <label style="float:left;" for="dateString">
    ...
    <%-- publish time --%>
    <div class="row">
        <label style="width:10%; float:left;" for="dateString">
  ...
  <a href="#" class="controlToggle" onclick="javascript:toggleControl('commentControlToggle','commentControl')">
     <fmt:message key="weblogEdit.commentSettings" />
  </a>
  </div>
  ...
  <c:if test="${model.hasPagePlugins}">
      ...
      <a href="#" class="controlToggle" onclick="javascript:toggleControl('pluginControlToggle','pluginControl')">
  ...
  <a href="#" class="controlToggle" onclick="javascript:toggleControl('miscControlToggle','miscControl')">
