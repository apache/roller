...
<body>
	...
	<div id="page">
    	...
    	<% if ( request.getRequestURI().indexOf("index.jsp") == -1 ) { %> 
    		<roller:EditorNavigationBar model="editor-menu.xml" view="/menu-tabbed.vm" />
    	<% } %> 
...
java.util.ResourceBundle bundle = 
   java.util.ResourceBundle.getBundle(
       "org.roller.presentation.ApplicationResources",locale);
...
<form>
<textarea rows="30" style="font-size:8pt;width:95%">
<% 
if ( null != exception ) {
   exception.printStackTrace(new java.io.PrintWriter(out));
}
else {
   out.println(bundle.getString("errorPage.noException"));
}
%>
</textarea>
</form>
