...
<%
String oscacheKey = "_index_jsp_data_" + request.getParameter("cat");
String language = ((Locale) request.getSession().getAttribute(org.apache.struts.Globals.LOCALE_KEY)).getLanguage();
%>
...
<c:set var="pinnedPosts" value="${data.weblogEntriesPinnedToMain}" />
