...
A) A Roller GroovletRenderer that can evaluate a Roller template as Groovy code
...
B) A Roller GSPRenderer that can evaluate a Roller template as a Groovy Template
...
To use renderers (A) and (B) in Roller:
