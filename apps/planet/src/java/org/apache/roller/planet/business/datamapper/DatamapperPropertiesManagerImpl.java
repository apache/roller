...
public class DatamapperPropertiesManagerImpl  extends AbstractManagerImpl implements PropertiesManager {
    ...
    private DatamapperPersistenceStrategy strategy = null;
    
    
    /**
     * Creates a new instance of DatamapperPropertiesManagerImpl
     */
    public DatamapperPropertiesManagerImpl(DatamapperPersistenceStrategy strat) {
    ...
    public Map getProperties() throws RollerException {
        ...
        List list = (List) strategy.newQuery(PropertyData.class,
                "PropertyData.getAll").execute();
        /*
