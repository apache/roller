...
<link rel="stylesheet" type="text/css" media="all" href="<s:url value='/roller-ui/styles/yui/reset-fonts-grids.css'/>" />
<link rel="stylesheet" type="text/css" media="all" href="<s:url value='/roller-ui/styles/yui/base-min.css'/>" />
