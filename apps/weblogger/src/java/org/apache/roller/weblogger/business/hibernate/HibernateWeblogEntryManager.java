...
public class HibernateWeblogEntryManager implements WeblogEntryManager {
    
    static final long serialVersionUID = -3730860865389981439L;
    
    private static Log log = LogFactory.getLog(HibernateWeblogEntryManager.class);
    ...
    protected HibernateWeblogEntryManager(Weblogger roller, HibernatePersistenceStrategy strat) {
