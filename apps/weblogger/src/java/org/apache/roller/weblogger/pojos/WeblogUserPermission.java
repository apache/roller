 ...
 * @author Dave Johnson
 */
public class WeblogUserPermission 
{
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof WeblogUserPermission != true) return false;
        WeblogUserPermission o = (WeblogUserPermission)other;
